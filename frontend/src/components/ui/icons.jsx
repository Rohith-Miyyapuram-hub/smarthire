/**
 * Central icon library — all SVG icons used across SmartHire.
 * Every icon accepts className as a prop for sizing/color via Tailwind.
 * Standard size: w-4 h-4 (16px) inline, w-5 h-5 (20px) for buttons/nav.
 */
